...
class Test_case:
    ...
    def test_prod_staging(self, keyword_value):
        ...
        time.sleep(2.2)
        test_value = Test_case().search_api(HOST_eve="test", keyword=keyword_value, scope="semkeyword").json()
        staging_value = Test_case().search_api(HOST_eve="staging", keyword=keyword_value, scope="semkeyword").json()
